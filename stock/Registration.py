...
import re
window =tk.Tk()
window.geometry("%dx%d+0+0" % (700, 750))
...
l1=tk.Label(window,text="Registration Form",font=("Times new roman", 25, "bold"),bg="green",fg="white")
l1.place(x=220, y=40)
...
btn=tk.Button(window, text="Login", bg ="brown", fg = "white", width=15, height=2, command=log)
